...
export default function HeroSection() {
  ...
  return (
    <AnimatePresence>
      <div className="relative flex min-h-[100vh] w-screen flex-col overflow-hidden bg-[#F2F3F5] font-medium sm:min-h-screen">
        ...
        <main className="static z-[100] flex h-[90%] w-screen grid-rows-[1fr_repeat(3,auto)_1fr] flex-col justify-center overflow-hidden px-4 pt-[30px] pb-[320px] md:fixed md:px-20 md:py-0">
          {/* biome-ignore lint/a11y/noSvgWithoutTitle: <explanation> */}
          <motion.svg
            ...
            className="row-start-2 mb-8 block w-[180px] md:mb-6"
            viewBox="0 0 614 94"
            fill="none"
          ...
          <motion.h1
            ...
            className="relative z-[100] text-[12vw] leading-[1.1] font-bold tracking-[-2px] text-[#1E2B3A] md:mb-[37px] md:ml-[-10px] md:text-[110px]"
          >
            Ihr Katalysator <br />
          ...
          <motion.div
            ...
            className="z-20 mx-0 mt-8 mb-0 flex max-w-2xl flex-row justify-center md:mt-0 md:mb-[35px] md:space-x-8"
          >
            <div className="w-full">
              <p className="text-lg leading-relaxed font-medium text-[#1a2b3b]">
          ...
          <div className="mt-8 flex gap-[15px] md:mt-0">
            ...
            >
              <Link
                href="/signin"
                target="_blank"
                className="group flex scale-100 items-center justify-center gap-x-2 rounded-full bg-[#407BBF] px-4 py-2 text-[13px] font-medium text-white no-underline shadow-md transition-colors duration-200 hover:bg-[#1a2b3b] active:scale-95"
                // style={{
                //   boxShadow:
        ...
        {/* biome-ignore lint/style/useSelfClosingElements: <explanation> */}
        <div
          className="fixed top-0 right-0 h-screen w-[80%] bg-[#1F2B3A]/20 md:w-1/2"
          style={{
            clipPath:
        ...
        <motion.canvas
          ...
          id="gradient-canvas"
          data-transition-in
          className="fixed top-0 right-[-2px] z-40 h-screen w-[80%] bg-[#c3e4ff] md:w-1/2"
        ></motion.canvas>
      </div>
    </AnimatePresence>
  )
