          ...
          value: class {
            ...
            setSize(width = 1, height = 1, orientation = 'xz') {
              ...
              for (let yIndex = 0; yIndex <= geometry.ySegCount; yIndex++) {
                const y = offsetY + yIndex * segmentHeight
                for (let xIndex = 0; xIndex <= geometry.xSegCount; xIndex++) {
                  const x = offsetX + xIndex * segmentWidth
                  const index = yIndex * (geometry.xSegCount + 1) + xIndex
                  geometry.attributes.position.values[
                    3 * index + 'xyz'.indexOf(orientation[0])
                  ] = x
                  geometry.attributes.position.values[
                    3 * index + 'xyz'.indexOf(orientation[1])
                  ] = -y
                }
              }
        ...
        Mesh: {
          ...
          value: class {
            ...
            draw() {
              ...
              for (const { uniform, location } of this.material
                .uniformInstances) {
